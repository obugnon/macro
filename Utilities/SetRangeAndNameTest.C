...
enum eVariable{kRawYield, kInvariantYield, kCRpp, kRaa, kAccEff, kRaaModels};
...
//___________________________________________________________________________________________________________
//___________________________________________________________________________________________________________
TString SetRangeValue(eVariable varType, Double_t minY, Double_t maxY, Double_t minPt, Double_t maxPt, Int_t minCent=0, Int_t maxCent=0, Double_t impactParameter=0.0)
{
    TString s;
    switch (varType)
    {
        ...
        case kRaaModels:
            s.Form("rapidity%.1f-%.1f_pT%.1f-%.1f_b%.1f", minY, maxY, minPt, maxPt, impactParameter);
        break;
